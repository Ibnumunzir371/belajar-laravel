                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" id="exampleUsername"
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('login') }}">jika sudah punya akun silahkan login</a>
                            </div>
                        </div>
                    </div>
                </div>
